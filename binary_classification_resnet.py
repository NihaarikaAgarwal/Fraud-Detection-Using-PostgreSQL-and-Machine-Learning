...
image_folder = '/home/nagarw48/Projects/DISML/binary_data'  
...
def calculate_metrics(true_labels, predictions):
    precision, recall, f1, _ = precision_recall_fscore_support(true_labels, predictions, average='macro', zero_division = 1)
...
torch.save(trained_model.state_dict(), "fraud_binary_resnet18.pth")
